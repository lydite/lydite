...
// nothing could be more faithful. The others have no parser in the Go standard
...
const (
	...
	TSX
	// Python reads .py. One grammar covers the language: there is no extension
	// whose syntax the tables cannot read, the way .tsx splits from .ts.
	Python
)
