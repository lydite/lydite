...
| [`referral-and-clearance.md`](../../agentic/references/referral-and-clearance.md) | `internal/referral`, `internal/clearance`, `internal/forge`, `internal/depdelta`, `internal/apisurface`, `internal/rustapisurface`, `internal/declaration`, and `internal/gitstate`'s tag resolution that `lydite release check` reads |
