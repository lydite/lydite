// Canonical lydite ESLint config. This file is embedded into the lydite
...
export default [
  ...
  },
  {
    ...
    // project lydite would scan nothing and still report [PASS]. Naming the
    ...
    languageOptions: {
      ...
      // package's tsconfig, which lydite has no business guessing at.
      parser: tsParser,
      ecmaVersion: "latest",
      sourceType: "module",
    },
